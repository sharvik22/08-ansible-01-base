...
![image](https://github.com/user-attachments/assets/f25e615a-9d62-41cb-ae8b-478b60e5cf54)

2. Зашифруйте отдельное значение `PaSSw0rd` для переменной `some_fact` паролем `netology`. Добавьте полученное значение в `group_vars/all/exmp.yml`.

* ansible-vault encrypt_string "PaSSw0rd"

![image](https://github.com/user-attachments/assets/f415cb58-fa0e-41c5-a0d9-5a1c8e5ddfb9)

* nano group_vars/all/examp.yml

![image](https://github.com/user-attachments/assets/24009160-b6a4-484e-af6f-34f700b1c696)

3. Запустите `playbook`, убедитесь, что для нужных хостов применился новый `fact`.

* ansible-playbook -i inventory/prod.yml site.yml --ask-vault-pass

![image](https://github.com/user-attachments/assets/5339c2c2-e05c-48e9-bb7b-f2dac8cd86e2)
...
![image](https://github.com/user-attachments/assets/6e515a03-e8fc-4b88-875f-820189febca9)

![image](https://github.com/user-attachments/assets/614a7914-edf5-41ad-94ca-81a66121e562)
